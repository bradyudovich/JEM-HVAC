...
export const metadata = createPageMetadata({
  title: 'Home',
  description:
    'Westminster MD HVAC experts for heating and air conditioning repair, installation, and maintenance. JEM delivers service, fair pricing, and lasting comfort.',
  path: '/',
})
